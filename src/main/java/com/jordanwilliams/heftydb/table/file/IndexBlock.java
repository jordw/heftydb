...
public class IndexBlock implements Iterable<IndexRecord>, Offheap {
  ...
  public static class Cache {
    ...
    public Cache(long maxSizeBytes) {
      cache =
          CacheBuilder.newBuilder().concurrencyLevel(64).weigher(new Weigher<String, IndexBlock>() {
            @Override
            ...
            public void onRemoval(
                RemovalNotification<String, IndexBlock> objectObjectRemovalNotification) {
