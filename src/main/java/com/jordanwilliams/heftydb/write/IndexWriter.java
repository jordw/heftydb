...
public class IndexWriter {
  ...
  private IndexRecord writeIndexBlock(IndexBlock indexBlock) throws IOException {
    ...
    IndexRecord
        metaIndexRecord =
        new IndexRecord(startRecord.startKey(), startRecord.snapshotId(), indexBlockOffset, false);
    indexBlock.memory().release();
    return metaIndexRecord;
  }

  public static IndexWriter open(long tableId, Paths paths, int maxIndexSizeBytes)
      throws IOException {
